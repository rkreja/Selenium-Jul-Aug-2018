...
public class Registration extends TestBase {
	...
	@Test(testName="Registration Tests for UI Class", priority=1, enabled=true)
	public void TC001_Registration_Tests() {
...
//		Step 2	Click Sign in button from top right corner of the page
		...
		UI.clickElementByXpath("//a[@title='Log in to your customer account']\"");
...
//		Step 4	Click create an account button
		...
		UI.clearByXpath("//button[@name='SubmitCreate']");
...
//		Assert.assertEquals(AccountVerify, 	true);
		UI.verifyElementEnable(driver.findElement(By.xpath("//li[contains(text(), 'An account using this email address')]")));
...
//		Assert.assertEquals(accountVerify, "An account using this email address has already been registered. Please enter a valid password or request a new one.");
		UI.verifyTextByXpath("//li[contains(text(), 'An account using this email address')]", "An account using this email address has already been registered. Please enter a valid password or request a new one.");
...
//		Step 7	Click create an account button
		...
		UI.clickElementByXpath("//button[@id='SubmitCreate']");
...
//		Step 17	Select 'Mr' radio button
		...
		UI.clickElementByXpath("//input[@id='id_gender1']");
...
//		dropDown_Day.selectByValue("28");
		UI.ItemSelectByIndex(driver.findElement(By.id("days")), 28);
...
//		Step 27	Enter Company as 'Time and Training' in Company text field
		...
		UI.enterTextByXpath("//input[@id='company']", "Time and Training");
...
//		Step 31	Enter '10001' in Zip/Postal Code text field
		...
		UI.enterTextByXpath("//input[@id='postcode']", "10001");
...
//		Step 33	Enter text 'Registering ac account with all fields' in Additional information text area
		...
		UI.enterTextByXpath("//textarea[@id='other']", "Registering ac account with all fields");
		
//		Step 34	Enter '7031234567' in Home Phone text field
		//driver.findElement(By.xpath("//input[@id='phone']")).sendKeys("7031234567");
		UI.enterTextByXpath("//input[@id='phone']", "7031234567");
...
//		Step 35	Enter Enter '7039876543214' in Mobile phone text field
		...
		UI.enterTextByXpath("//input[@id='phone_mobile']", "7039876543214");
...
//		Step 36	Replace text 'My Address' to 'Home' in Assign an address alias for future reference text field
		...
		UI.enterTextByXpath("//input[@id='alias']", "My Address");
		
//		Step 37	Click 'Register' button
		//driver.findElement(By.xpath("//button[@id='submitAccount']")).click();
		UI.clickElementByXpath("//button[@id='submitAccount']");
...
//		Step 41	Click 'Sign out' button from top right corner
		...
		UI.clickElementByXpath("//a[text()='Sign out']");
